...
# MasterAI 德州源码、德州扑克、 AI 捕鱼源码与周易八字传统文化软件
...
德州扑克主仓库记录 Unity 客户端与 C++ 服务端相关模块，并覆盖俱乐部、牌桌、好友局、SNG 和 MTT 等产品流程。实际部署前请独立验证依赖、性能、安全性和合规要求。
...
- [查看德州扑克完整方案](https://github.com/masterai-top/TexasHoldem-Poker-Complete-Solution)
- [德州积分大厅](https://github.com/masterai-top/Texas-Hold-em-Points-Lobby)
- [查看德州扑克赛事平台](https://github.com/masterai-top/Texas-Holdem-Poker-Tournament-Event-Platform)
- [查看 CFR 扑克 AI](https://github.com/masterai-top/cfr-poker-ai-masterai)


## 德州积分大厅 | Texas Hold'em Points Lobby

德州积分大厅项目覆盖金币/积分大厅、俱乐部、联盟、朋友局、SNG、MTT、短牌及多人牌桌相关流程。以下图片来自该项目当前线上 README。

<table>
  <tr>
    <td width="50%"><img src="https://github.com/user-attachments/assets/7da76d6b-c7fd-4e36-87e8-61f5bd504438" alt="德州积分大厅与俱乐部界面 Texas Hold'em points lobby and poker club" width="100%"></td>
    <td width="50%"><img src="https://github.com/user-attachments/assets/3dda8ea6-b7d1-4679-8ca1-8469e68b6c97" alt="德州积分大厅九人牌桌 Texas Hold'em nine-player table" width="100%"></td>
  </tr>
</table>

- [查看德州积分大厅项目](https://github.com/masterai-top/Texas-Hold-em-Points-Lobby)

## 德州扑克 AI | CFR Poker AI

MasterAI CFR 项目面向单挑无限注德州扑克策略研究，覆盖 CFR、反事实价值计算、自我博弈、训练和评估相关模块。性能与胜率应以可复现实验和当前版本为准。

<table>
  <tr>
    <td width="50%"><img src="https://github.com/user-attachments/assets/66851632-7b29-4fc3-a35c-76dee4e5930d" alt="MasterAI 德州扑克 AI 运行界面 MasterAI poker AI interface" width="100%"></td>
    <td width="50%"><img src="https://github.com/user-attachments/assets/8cba978a-8a2f-4310-b650-d96adf1dd633" alt="德州扑克 AI 策略可视化 Texas Hold'em AI strategy visualization" width="100%"></td>
  </tr>
</table>

- [查看 CFR 德州扑克 AI 项目](https://github.com/masterai-top/cfr-poker-ai-masterai)

## 捕鱼游戏平台 | Arcade Fishing Platform


OceanRaid 项目记录 Cocos/Lua 客户端、Python/C++ 服务端、Node.js 运营接口及捕鱼比赛相关页面。图片来自项目当前公开截图目录。
...
- [查看 OceanRaid 捕鱼游戏平台](https://github.com/masterai-top/OceanRaid-Fishing-Game-Platform)


## 周易与命理软件 | Chinese Metaphysics Software


综合命理仓库覆盖八字、紫微斗数、奇门遁甲及相关排盘展示。内容用于软件与传统文化算法研究，不应替代医疗、法律、财务或其他专业建议。
...
- [查看综合命理排盘系统](https://github.com/masterai-top/Bazi-Ziwei-Qimen-Dunjia-Divination-System-Source-Code)
- [查看浏览器端周易排盘项目](https://github.com/masterai-top/Zhouyi-Divination-System-Source-Code)
...
- [全部公开仓库](https://github.com/masterai-top?tab=repositories)
- [MasterAI 项目网站](https://masterai-top.github.io/masterai-top/)
...
各仓库的许可证可能不同。使用、修改、分发或部署前，请检查对应仓库的 `LICENSE`、第三方依赖和素材授权，并遵守所在地法律及平台规则。
